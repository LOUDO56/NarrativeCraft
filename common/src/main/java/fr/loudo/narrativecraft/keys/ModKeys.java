...
public class ModKeys {
    ...
    public static final KeyMapping OPEN_KEYFRAME_EDIT_SCREEN = registerKey("key.cutscene.keyframes.cutscene_controller_screen", InputConstants.KEY_G);
    public static final KeyMapping NEXT_DIALOG = registerKey("key.dialog.next", InputConstants.KEY_M);
